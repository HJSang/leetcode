...
# Each element is either an integer or a list -- whose elements may also be inteters or other lists
# Different from the previous question: https://leetcode.com/problems/nested-list-weight-sum/
# where weight is increasing from the root to leaf, now the weigt is defined from bottom up
